...
function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
  ...
  if (entity.type === "IMAGE") {
    ...
    return `<div style="margin: 10;display:flex;justify-content: center;">
    <img src="${entity.data.src}" alt="" style="min-width: 300px;max-width: 540px; max-height: 300px;object-fit:contain;" />
      ...
      blocks.forEach(function (block) {
        if (block.type === "code") {
          ...
          if (listBlocks.length > 0) {
            ...
            html.push({ val: listHtml, code: false });
            listBlocks = [];
          }
          ...
          html.push({ val: blockHtml, code: false });
        }
      });
